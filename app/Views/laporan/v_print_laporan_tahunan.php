  ...
  <table class="table table-bordered table-striped">
    ...
    <?php $no=1; 
      ...
      <tr class="text-center bg-gray">
        ...
        <td class="tg-0lax">Rp. <?= $datatahunan == null ? '' : number_format(array_sum($grandtotal),0)  ?></td>
        <td class="tg-0lax">Rp. <?= $datatahunan == null ? '' : number_format(array_sum($granduntung),0)  ?></td>
